...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="modules/common/css/bootstrap.css" rel="stylesheet">

    <!-- Add custom CSS here -->
    <link href="modules/admin_panel/css/sb-admin.css" rel="stylesheet">
    <link rel="stylesheet" href="modules/admin_panel/font-awesome/css/font-awesome.min.css">
    <!-- Page Specific CSS -->
...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
            ...
            <li><a href="modules/admin_panel/pages/typography.html"><i class="fa fa-font"></i> Typography</a></li>
            <li><a href="modules/admin_panel/pages/bootstrap-elements.html"><i class="fa fa-desktop"></i> Bootstrap Elements</a></li>
            <li><a href="modules/admin_panel/pages/bootstrap-grid.html"><i class="fa fa-wrench"></i> Bootstrap Grid</a></li>
            <li><a href="modules/admin_panel/pages/blank-page.html"><i class="fa fa-file"></i> Blank Page</a></li>
            <li class="dropdown">
...
<!-- JavaScript -->
<script src="modules/common/js/jquery/jquery-1.10.2.js"></script>
<script src="modules/common/js/bootstrap/bootstrap.js"></script>

<!-- Page Specific Plugins -->
<script src="http://cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js"></script>
<script src="http://cdn.oesmith.co.uk/morris-0.4.3.min.js"></script>
<script src="modules/admin_panel/js/morris/chart-data-morris.js"></script>
<script src="modules/admin_panel/js/tablesorter/jquery.tablesorter.js"></script>
<script src="modules/admin_panel/js/tablesorter/tables.js"></script>
