...
<form id="reservation-add" class="form-horizontal" action="reservation-add">
...
<div class="form-group">
    ...
    <div class="col-lg-8">
        <input type="text" id="ra-email" name="email" placeholder="sample@sample.com" class="validate[required] form-control">
    </div>
</div>
<!-- /.form-group -->
...
<div class="form-group">
    ...
    <div class="col-lg-8">
        <div class="input-group">
            <input id="ra-phone_number" name="phone_number" class="form-control" type="text" data-mask="+99 999 999 999">
...
<div class="form-group">
    ...
    <div class="col-lg-8">
        <input type="text" id="ra-city" name="address-city" placeholder="eg: Kraków" class="validate[required] form-control">
    </div>
</div>
<!-- /.form-group -->
...
<div class="form-group">
    ...
    <div class="col-lg-8">
        <input type="text" id="ra-street" name="address-street" placeholder="eg: Zakopiańska" class="validate[required] form-control">
    </div>
</div>
<!-- /.form-group -->
...
<div class="form-group">
    ...
    <div class="col-lg-8">
        <div class="input-group">
            <input type="text" id="ra-postcode" name="address-postcode" class="validate[required] form-control" data-mask="99-999">
...
<div class="col-lg-8">
<select name="address-country" id="ra-country" data-placeholder="Choose a Country..." class="form-control chzn-select" tabindex="2">
<option value=""></option>
...
<div class="form-group">
    <label class="control-label col-lg-4">Add Client</label>

    <div class="col-lg-8">
        <div class="input-group">
            <input type="submit" onclick="ajaxSubmit('#reservation-add'); return false;" class="btn btn-primary" data-original-title="" title="" value="Submit"/>
        </div>
    </div>
</div>
</form>
...
<div class="col-lg-6">
    <div class="box">
        <header>
            ...
            <h5>Select From Existing Client Database</h5>
